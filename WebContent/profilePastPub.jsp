    ...
    <body>
		...
		<%
			...
			if(session.getAttribute("user") == null) {
				...
				publicTravelBeansLst = profileController.loadMyOldTGR(username);
        ...
        <div class="container-fluid">
            <div class="row content">
                <div class="col-sm-3 sidenav">
                     ...
                     <ul class="nav nav-pills nav-stacked li2">
						...
						<ul class="dropdown-menu">
						      ...
						      <li class="active"><a href="profilePastPub.jsp">Public</a></li>
						</ul>
						</li>
                ...
                <div id="trvls" class="col-sm-9">
                    <h4><small>MY PAST PUBLIC TRAVELS</small></h4>
                    <hr>
                    <%	
